...
if (selectedStage) {
  ...
  fetch(`http://https://soft-landing-platform-production-0e16.up.railway.app//stages/${selectedStage.id}`, {
    method: 'PUT',
    headers: {
...
.then((data) => {
  ...
  return fetch('http://https://soft-landing-platform-production-0e16.up.railway.app//stages');
...
const handleDelete = (id: string) => {
  ...
  fetch(`http://https://soft-landing-platform-production-0e16.up.railway.app//stages/${id}`, {
    method: 'DELETE'
  })
   .then((res) => res.json())
.then((data) => {
...
onReorder={(newOrder) => {
  ...
  fetch('http://https://soft-landing-platform-production-0e16.up.railway.app//stages/reorder', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json'
    },
